...
export default defineConfig({
  testDir: './e2e',
  testMatch: ['reload-smoke.spec.ts', 'multitab-guard.spec.ts', 'storage-pressure.spec.ts', 'sim-advance-journal.spec.ts', 'econ-clock.spec.ts', 'arbitration-drama.spec.ts', 'qualifying-offers.spec.ts'],
  fullyParallel: false,
  forbidOnly: isCi,
