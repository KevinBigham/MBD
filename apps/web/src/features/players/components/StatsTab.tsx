  ...
  return (
    <div className="space-y-6">
      {player.stats ? (
        ...
        <DensePanel title="Season Stats" bodyClassName="p-8 text-center font-heading text-sm text-dynasty-muted">
          No stats yet. Sim games to see this player&apos;s performance.
        </DensePanel>
      )}

      {advanced ? (
        <DensePanel title="Advanced Stats">
          {isPitcher ? (
      ...
      <DensePanel title="Career Totals" bodyClassName="space-y-4">
        {careerStats ? (
          <>
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
